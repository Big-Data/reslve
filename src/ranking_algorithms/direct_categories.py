...
class DirectCategory_ID_VSM(VSM_Algorithm):
    ...
    def __init__(self):
        VSM_Algorithm.__init__(self, 'reslveID_directcategory_id_vsm', "article direct parent categories' IDs", "directCatID")
...
class DirectCategory_TitleBOW_VSM(VSM_Algorithm):
    ...
    def __init__(self):
        VSM_Algorithm.__init__(self, 'reslveID_directcategory_titlebow_vsm', "article direct categories' titles BOW", "directCatTitleBOW")
