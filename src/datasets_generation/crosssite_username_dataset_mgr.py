...
def __get_usernames_csv_path__(site):
    ...
    return 'datasets/spreadsheets/cross-site-usernames_'+str(site.siteName)+'.csv'
def __get_nonexistent_usernames_cache_path__(site):
    ''' @param site: a Site object
        @return: the cache of usernames that do no exist on the given site '''
    return 'datasets/pickles/nonexistent_usernames_on_'+str(site.siteName)+'.pkl'
__wikipedia_editors_cache_path__ = 'datasets/pickles/wikipedia_editors_cache.pkl'
